...
import com.edu.ykt003.education.util.MediaUtils;
 ...
 * @date 2017/3/2 9:31
 */
public class VideoIjkPlayerActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.mContext = this;
        rootView = getLayoutInflater().from(this).inflate(R.layout.activity_ijkplayer, null);
        ...
        if (!new File(url1).exists()) {
            url1 = SystemConfig.videoUrlNei_H;
        }
        String url2 = SystemConfig.videoUrlNei_H;
            ...
            public PlayerView setPlaySource(List<VideoijkBean> list) {
                ...
                .showThumbnail(new OnShowThumbnailListener() {
                    ...
                    public void onShowThumbnail(ImageView ivThumbnail) {
                        Glide.with(mContext)
                                .load(SystemConfig.picUrlWai)
                                .placeholder(R.color.ijkplayer_cl_default)
                                .error(R.color.ijkplayer_cl_error)
                                .into(ivThumbnail);
                    }
                })
                .setPlaySource(list)
